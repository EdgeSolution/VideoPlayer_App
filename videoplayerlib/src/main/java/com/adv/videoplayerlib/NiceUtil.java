...
import static com.adv.videoplayerlib.NiceVideoPlayer.videoMap;
...
public class NiceUtil {
    ...
    public static void putKeyValue(String path, String state) {
        videoMap.put(path, state);
    }

    public static void setKeyValue(String path,String value) {
        if(videoMap.containsKey(path)) {
            //videoMap.remove(path);
            videoMap.put(path,value);
        }
    }
    ...
    public static void test() {
        ...
        while(it.hasNext()){
            ...
            System.out.println(key + "  haha:  " + value);
    ...
    public static String getKeyValue(String keyValue) {
        ...
        //Set<String> set = videoMap.keySet();
        //String vaildPath = null;
